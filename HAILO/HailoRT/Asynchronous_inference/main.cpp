...
// Queue to store preprocessed input frames 
...
{
    // Parses model output and draws bounding boxes
...
int main(int argc, char** argv)
{
    try {
        ...
        vis_param.score_thresh = 0.5f;
        vis_param.max_boxes_to_draw = 20;
        ...
        // Determine input source (image/video/camera)
        ...
        // Map model input stream to queue
